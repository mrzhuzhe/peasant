...
long test_ioctl_ioctl(struct file *filp, unsigned int cmd, 
                             unsigned long arg) 
{ 
...
ssize_t test_ioctl_read(struct file *filp, char __user *buf, 
...
int test_ioctl_close(struct inode *inode, struct file *filp) 
{ 
    pr_alert("%s call.\n", __func__); 
...
int test_ioctl_open(struct inode *inode, struct file *filp) 
{ 
