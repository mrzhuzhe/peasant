...
#define SEM_MUTEX_KEY "./outputs/sem-mutex-key"
#define SEM_BUFFER_COUNT_KEY "./outputs/sem-buffer-count-key"
#define SEM_SPOOL_SIGNAL_KEY "./outputs/sem-spool-signal-key"
